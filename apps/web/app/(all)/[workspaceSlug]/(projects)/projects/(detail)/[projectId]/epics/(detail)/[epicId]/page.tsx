...
/**
 * Resolves an epic id to its `/browse` URL, exactly as the work-item detail route does.
 *
 * An epic is an ordinary work item, so `/browse/:identifier-:sequence` already renders it --
 * that page picks `EIssueServiceType.EPICS` off `is_epic` on its own. This route exists so
 * that an epic id in a URL resolves the same way a work item id does, rather than 404ing
 * and leaving the two kinds of link inconsistent.
 */
